    ...
    const createParticles = () => {
      ...
      for (let i = 0; i < 50; i++) {
        ...
        particles.push({
          ...
          color: `rgba(0, ${Math.floor(Math.random() * 155) + 100}, 0, ${
            Math.random() * 0.3 + 0.1
          })`,
        });
      }
...
const CategoryCard = ({ icon: Icon, name }) => {
  return (
    <motion.div
      ...
      whileHover={{
        y: -10,
        boxShadow: "0 10px 30px -10px rgba(0, 255, 0, 0.3)",
      }}
    >
      ...
      <div className="flex items-center mb-4">
        {Array.from({ length: 5 }).map((_, i) => (
          <Star
            ...
            className={cn(
              "h-4 w-4 mr-1",
              i < rating ? "text-green-500 fill-green-500" : "text-gray-600"
            )}
          />
        ))}
      </div>
  ...
  const reviews = [
    {
      ...
      rating: 5,
      comment:
        "The BlackShark V2 Pro completely changed my gaming experience. The audio quality is unmatched!",
    },
    {
      author: "Sarah K.",
      rating: 5,
      comment:
        "Razer Blade 15 is the perfect balance of power and portability. Best laptop I've ever owned.",
    },
    {
      author: "Michael T.",
      rating: 4,
      comment:
        "The Huntsman V2 is incredibly responsive. The optical switches make a noticeable difference.",
    },
    {
      author: "Jessica L.",
      rating: 5,
      comment:
        "Viper Ultimate is so light and precise. Battery life is impressive too!",
    },
  ];
      ...
      <main className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <div className="hero-content text-center max-w-4xl px-4">
              ...
              >
                ...
                and precision engineering designed for the most immersive
                gameplay.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center min-h-[600px]">
                ...
                >
                  ...
                  <div className="space-y-3 pt-2">
                    ...
                    <ul className="space-y-2">
                      {featuredProducts[activeProductIndex].features.map(
                        (feature, idx) => (
                          <motion.li
                            key={idx}
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-4">
                    ...
                    <Button
                      variant="outline"
                      className="border-green-500 text-green-500 hover:bg-green-500/10 px-6 py-6 rounded-md text-base"
                    >
                      View Details
                    </Button>
                  </div>
            ...
            <div className="order-1 lg:order-2 h-[500px] relative">
              <AnimatePresence mode="wait">
                ...
                >
                  <Spline
                    scene={featuredProducts[activeProductIndex].sceneUrl}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-400">
                    Our products are designed to deliver not just performance,
                    but also aesthetics that stand out in any gaming setup.
                  </p>
                </div>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-400">
                    We push the boundaries of what's possible, integrating the
                    latest innovations to give you a competitive edge.
                  </p>
                </div>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-400">
                    Every product is designed with input from professional
                    gamers and the community to ensure it meets real gaming
                    needs.
                  </p>
                </div>
              </motion.div>
        ...
        >
          ...
          <div className="text-center mt-12">
            <Button
              variant="outline"
              className="border-green-500 text-green-500 hover:bg-green-500/10 px-8 py-6 rounded-md text-lg"
            >
              View All News
            </Button>
          </div>
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                ...
                <p className="text-xl md:text-2xl mb-10 text-gray-300">
                  Get exclusive access to deals, early product announcements,
                  and Razer ID rewards.
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <Link to="/products">
                    <Button className="bg-green-600 hover:bg-green-700 text-white px-8 py-7 rounded-md text-lg group relative overflow-hidden">
